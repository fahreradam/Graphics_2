...
Material = collections.namedtuple("Material", "baseTexture baseTextureIndex emissiveTexture normalTexture "
                                              "normalTextureIndex name mrTexture")
    ...
    def getMeshData(self, bufferDatas, J, mesh):
        ...
        for prim in mesh["primitives"]:
            ...
            vstart, istart = BufferManager.addIndexedData(
                positiondata=positions, basetexturedata=basetexcoords,
                bumptexturedata=bumptexcoords, normaldata=normals, indexdata=indices, tangentdata=tangents)
